...
> seen the crops in an actual market. The audio has not moved: all 1176 clips say,
...
app/assets/                the 89 illustrations and the 1176 clips, generated by scripts/
...
| --- | --- | --- |
| Every clip a native-speaker recording | v1.0 (R1) | All 1176 are placeholders that say so; the kit is written, the speakers are not found |
