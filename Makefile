...
.PHONY: ci
ci: doc-check design-check audio-check picture-check analyze test coverage-gate ## Everything CI runs

.PHONY: gates
gates: doc-check design-check audio-check picture-check coverage-gate ## The blocking gates alone. These never go yellow.
